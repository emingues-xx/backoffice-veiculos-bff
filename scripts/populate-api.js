...
// JWT token para autenticação (gerado em 2025-01-23)
const AUTH_TOKEN = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjY4ZDE3ODQ1YTA4ZGY5Zjk4MmUzMzk3YSIsImVtYWlsIjoiYWRtaW5AdGVzdC5jb20iLCJyb2xlIjoiYWRtaW4iLCJpYXQiOjE3NTg1NzkxMzEsImV4cCI6MTc1ODY2NTUzMX0.E-cm9k9FRQ_TgM4m0amr5nSr8KDPwQbvIdK0wjDoF1E';
...
async function populateAPI() {
  console.log('🚀 Iniciando população da API com 20 veículos...\n');
